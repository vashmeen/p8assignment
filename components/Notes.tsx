...
const Notes = () => {
  return (
    <div className='mt-40 mx-auto max-w-screen-md space-y-4 pb-32'>
      ...
      <p>
        I added a 500ms debounce time to prevent requests to server, while user is dragging the sliders. It means in
        case of a change, the validation and submission are called if no change happens after 500ms.
      </p>
